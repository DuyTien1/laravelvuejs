            ...
            <div class="row d-flex justify-content-center">
                <div class="col-12 col-sm-8">
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-sm-8">
                            <a-input placeholder="Tên Người Dùng" allow-clear v-model:value="author_name"
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-sm-3 text-start text-sm-end">
                            <label>
                                <span class="text-danger me-1">*</span>
                                <span :class="{ 'text-danger': errors.describe }">Mô Tả: </span>
                            </label>
                        </div>
                        <div class="col-12 col-sm-8">
                            <a-textarea placeholder="Giới Thiệu Về Tác Giả" allow-clear auto-size v-model:value="describe"
